...
test_key = '199900'
if get_matching_key( test_key ) ~= nil then
    print( 'get_matching_key( ' .. test_key .. ') did not return nil' )
else
    print( 'get_matching_key( ' .. test_key .. ') returned nil as expected' )
end

for _, test_key in ipairs( {'200000', '202001', '202100', '202101', '202301'} )
do
    print( 'get_matching_key( ' .. test_key .. ') returned ' .. get_matching_key( test_key ) )
end
